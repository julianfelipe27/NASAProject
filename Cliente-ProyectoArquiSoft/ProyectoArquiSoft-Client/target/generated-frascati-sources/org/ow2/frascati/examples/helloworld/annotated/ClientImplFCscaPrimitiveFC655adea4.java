...
public class ClientImplFCscaPrimitiveFC655adea4
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("r","java.lang.Runnable",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("printService","org.ow2.frascati.examples.helloworld.annotated.PrintService",true,true,false),} );
    }
  ...
  public Object getFcContentDesc()  {
      return "org.ow2.frascati.examples.helloworld.annotated.ClientImpl";
  }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    ic.content = org.ow2.frascati.examples.helloworld.annotated.ClientImpl.class;
    ...
    intercept = new org.ow2.frascati.examples.helloworld.annotated.PrintServiceInterceptorSCAIntent();
    ic.controllers.add(intercept);
    proxy = new org.ow2.frascati.examples.helloworld.annotated.PrintServiceFcOutItf(proxyForCompCtrl,"printService",new org.objectweb.fractal.julia.type.BasicInterfaceType("printService","org.ow2.frascati.examples.helloworld.annotated.PrintService",true,true,false),false,intercept);
    ic.interfaces.put("printService",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    initFcController(ic);
  ...
  public org.objectweb.fractal.api.Component newFcControllerInstantiation(org.objectweb.fractal.julia.InitializationContext ic) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    ic.controllers.add(ctrl = new org.ow2.frascati.examples.helloworld.annotated.ClientImplFCSCAContentControllerImpl());
